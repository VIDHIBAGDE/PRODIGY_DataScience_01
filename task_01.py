...
Original file is located at
    https://colab.research.google.com/drive/1Ty39pvH8B6mOWTrx-ar9BCaKKsbGaCc1
"""
...
columns = ['2001', '2002', '2003', '2004', '2005', '2006', '2007',
        '2008', '2009', '2010', '2011', '2012', '2013', '2014', '2015', '2016',
        '2017', '2018', '2019', '2020', '2021', '2022']
for i in columns:
    fig = plt.figure(figsize=(8, 5))
    plt.hist(df[i], color='maroon', bins=10)
    plt.xlabel(i)
    plt.show()
...
plt.barh(years, total_values, color='yellow')
...
for country_name, data_values in country_by_2001_t.iterrows():
    ...
    sns.barplot(x=data_values.index, y=data_values.values, palette='autumn')
